...
<div class="container">
    ...
    <form action="/admin/subcategories/${category.code}/${subcategory.code}" method="post">
        <input type="hidden" name="id" value="${subcategory.id}"/>

        <div class="form-group">
            <label>Nome</label>
            <input type="text" class="form-control" name="name" placeholder="Digite aqui o nome da subcategoria" value="${subcategory.name}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"
                   name="code" placeholder="por exemplo: java, python (não use letra maiúsculas, acentos ou caracteres especiais)" value="${subcategory.code}"/>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="orderInSystem"
                    placeholder="por exemplo: categoria de ordem 1 aparece antes da categoria de ordem 2" value="${subcategory.orderInSystem}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="description"
                   placeholder="por exemplo: Laravel, CakePHP e CodeIgniter são frameworks que você vai treinar bastante aqui." value="${subcategory.description}">
